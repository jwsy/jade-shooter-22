    ...
    "node_modules/howler/dist/howler.js"(exports) {
      ...
      (function() {
        ...
        HowlerGlobal.prototype.orientation = function(x, y, z2, xUp, yUp, zUp) {
          ...
          if (typeof x === "number") {
            self._orientation = [x, y, z2, xUp, yUp, zUp];
            if (typeof self.ctx.listener.forwardX !== "undefined") {
              ...
              self.ctx.listener.setOrientation(x, y, z2, xUp, yUp, zUp);
            }
          } else {
            return or2;
          }
...
`), font: U.fonts[rn], pos: f(r, -r), origin: "botleft", size: 16, width: F() * t.scale * 0.6, lineSpacing: r / 2, fixed: true, styles: { time: { color: E(127, 127, 127) }, info: { color: E(255, 255, 255) }, error: { color: E(255, 0, 127) } } });
  ...
  var initHowlH = new import_howler.Howl({
    src: ["sounds/score.mp3"],
    html5: true,
    format: ["mp3"],
    volume: 0.1
  });
  var scoreH = new import_howler.Howl({
    src: ["sounds/score.mp3"],
    html5: true,
    format: ["mp3"],
    volume: 0.6
  });
  var tstmp3H = new import_howler.Howl({
  ...
  scene("game", () => {
    ...
    const mousePosText = add([
      pos(width() * 0.6, 12 * 2),
      text("mpos: no mouse detected", { font: "sinko" }),
      { value: 0 },
      "debugText"
    ]);
  ...
  scene("start", () => {
    ...
    function addButton(txt, fontSize, p, f2) {
      const btn = add([
